...
This file is used to fetch majority protein identifier for each gene and generate a gene to protein mapping for both AT2 and AM cell lines. This file generates a list of protein names that can be used to fetch protein sequences. The list is used with the website https://www.uniprot.org/uploadlists/ the fields for the query are UniProtKP AC/ID to UniParc. 
